...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed May 28 17:08:20 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Reabilitation1.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h mainmenu.h settings.h process.h ialgorithm.h algomanager.h itracking.h idms.h iskeletization.h skeletization.h data.h tracking.h .tmp/Reabilitation1.0.0/ && $(COPY_FILE) --parents main.cpp mainmenu.cpp settings.cpp process.cpp algomanager.cpp skeletization.cpp data.cpp tracking.cpp qmlapplicationviewer/qmlapplicationviewer.cpp .tmp/Reabilitation1.0.0/ && (cd `dirname .tmp/Reabilitation1.0.0` && $(TAR) Reabilitation1.0.0.tar Reabilitation1.0.0 && $(COMPRESS) Reabilitation1.0.0.tar) && $(MOVE) `dirname .tmp/Reabilitation1.0.0`/Reabilitation1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Reabilitation1.0.0
